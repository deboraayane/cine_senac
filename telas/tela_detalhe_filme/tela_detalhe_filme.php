<!DOCTYPE html>
<html lang="pt-br">
<<<<<<< HEAD:telas/tela_detalhe_filme/tela_detalhe_filme.html
=======
  <head>
    <meta charset="UTF-8" />
...
>>>>>>> 63ce74a5633037338de83773db35712759a8bd3a:telas/tela_detalhe_filme/tela_detalhe_filme.php
...
<body>
  ...
  <main class="container">
    <section class="top-section">
      ...
      <div class="info-filme">
        <h2 class="title-secondary">Título do Filme</h2>
        <p><strong>Gênero:</strong> Ação, Aventura</p>
        <p><strong>Duração:</strong> 2h 15min</p>
        <p>
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugiat
          culpa quibusdam in suscipit impedit dolor doloremque.
        </p>
      </div>
    </section>
    ...
    <section class="trailer">
      ...
      <iframe width="100%" height="400" src="https://www.youtube.com/embed/6HsfXtgcAE4?si=DC6DaQM2BuwoAfql"
    ...
    <section class="schedule-section">
      ...
      <div class="session">
        <h4>2D</h4>
        <p class="days-available">Dias disponíveis: Seg, Qua, Sex</p>
        <div class="times">
          <button>13:00</button>
          <button>15:30</button>
          <button>18:00</button>
      ...
      <div class="session">
        <h4>3D</h4>
        <p class="days-available">Dias disponíveis: Ter, Qui, Sab</p>
        <div class="times">
          <button>14:00</button>
          <button>16:30</button>
          <button>19:00</button>
  ...
  <script>
    document.addEventListener("DOMContentLoaded", () => {
      document
        .querySelectorAll(".schedule-section .times button")
        .forEach((button) => {
          button.addEventListener("click", () => {
            alert(`Você selecionou o horário das ${button.textContent}`);
          });
        });
    });
