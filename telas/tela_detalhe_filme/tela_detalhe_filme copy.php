      ...
      <div class="session">
        ...
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:20px;">
          <button id="btnAnterior-2d"
            style="padding:6px 12px;background:#444;color:white;border:none;border-radius:5px;cursor:pointer;">←
            Anterior</button>
          <h3 id="mesAnoAtual-2d" style="margin:0;"></h3>
      ...
      <div class="session">
        ...
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:20px;">
          <button id="btnAnterior-3d"
            style="padding:6px 12px;background:#444;color:white;border:none;border-radius:5px;cursor:pointer;">←
            Anterior</button>
          <h3 id="mesAnoAtual-3d" style="margin:0;"></h3>
