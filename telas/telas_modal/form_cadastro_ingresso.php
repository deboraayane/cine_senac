...
if (
    ...
    foreach ($tipos as $tipo) {
        ...
        $sql = "INSERT INTO ingresso (filme_id, tipo_exibicao, data_sessao, horario_sessao)
    ...
    echo "<script>alert('Ingresso(s) cadastrado(s) com sucesso!.'); window.history.back();</script>";
